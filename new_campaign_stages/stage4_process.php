...
else
{
	...
	$sqlQuery = "UPDATE " .
	$wpdb->prefix . "spdfi_campaigns SET defaultcat = '$defaultpostcategory',filtercolumn = '$filtercolumn',filtercolumn2 = '$filtercolumn2',filtercolumn3 = '$filtercolumn3',filtermethod = '$pfm',stage = '4',allowupdate = '$defaultphase' WHERE id = '$camid'";
	$wpdb->query($sqlQuery);

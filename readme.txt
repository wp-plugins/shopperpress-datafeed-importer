...
== Changelog ==
= 0.4 =
1. More changes made to stage 4 submission, stage 5 (completion) now shows properly.
2. Default Category Parent on the Settings page now active.
3. Added tool tips on Stage 2.
4. Corrected fault with random time format.

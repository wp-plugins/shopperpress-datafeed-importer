<div class="wrap"> 
    ...
    <h2>ShopperPress DataFeed Importer Campaign Management</h2>
                            ...
                            <div id="post-body-content">
                                <div class="postbox closed">
                                    ...
                                    <table class="inside">
                                        ...
                                        $query = 'meta_key=spdfi_campaignid&meta_value=' . $camid . '&posts_per_page=100';
                                        query_posts( $query );
                        ...
                        <div id="post-body-content">
                            <div class="postbox closed">
                                ...
                                <div class="inside">
                                    ...
                                    <p><strong><a href="#" title="Indicates if your campaign is running, paused, updating etc">Status</a>:</strong> <?php echo spdfi_camman_stage($r->stage);?></p>
    ...
    <select name="allowupdate" size="1" <?php if(get_option('spdfi_demomode') == 1){echo 'disabled="disabled"';}?>>
                        ...
                        <div id="post-body-content">
                            <div class="postbox closed">
                                ...
                                <div class="inside">
                                    ...
                                    <p><strong><a href="#" title="Process method currently in use out of Full, Staggered or Scheduled">Process</a>:</strong> <?php echo spdfi_camman_process($r->process);?></p>
            ...
            {
                messagebox_spdfi('errorSmall', 'Failed To Retrieve Campaign Details!');
            }	
        }
    }
                ...
                <div class="postbox">
                    ...
                    <form>
                        <table width="667">
                            ...
                            <td><?php if( !$c ){ echo 'No Campaigns Found'; } ?></td>
                            </tr>

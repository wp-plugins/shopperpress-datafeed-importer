...
function spdfi_masspostdelete()
{
	...
	messagebox_spdfipro('successSmall', 'Success - ' . $totalpostdeleted . ' posts were deleted.');
}

function spdfi_masstagdelete()
{
	global $wpdb;
	...
	messagebox_spdfipro('successSmall', 'Success - All tags deleted.');
}

function spdfi_masspagedelete()
{
	global $wpdb;
	...
	messagebox_spdfipro('successSmall', 'Success - ' . $wpdb->rows_affected . ' pages were deleted.');
}

function spdfi_masscategorydelete()
{
	global $wpdb;
	@set_time_limit(21700);// maximum of six hours
	...
	messagebox_spdfipro('successSmall', 'Success - All categories have been deleted.');
}

...
/*
	...
	Description: Professional edition of the ShopperPress csv import plugin for wordpress, import csv data to make wordpress posts in massive numbers! Demo edition only.
	Author: Ryan Bayne
